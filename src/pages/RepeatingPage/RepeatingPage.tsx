...
import '../RepeatingPage/components/RepeatingSlider/RepeatingSlider'
...
export default function RepeatingPage() {
  ...
  return (
    <ContentWrapper>
      ...
      {Boolean(activeClass) && Boolean(activeThemeId) && <p className='click_note'>Чтобы узнать верный ответ, нажми на карточку</p>}
